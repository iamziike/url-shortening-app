...
const Navbar = () => {
  ...
  const menuOpenHandler = () => {
    setIsMenuButtonClick((prev) => !prev);
  };
    ...
    <nav className={classes.nav}>
      ...
      <div
        className={`${classes['links-wrapper']} ${
          isMenuButtonClick ? classes['links-wrapper--open'] : ''
        }`}
      >
        <ul className={classes.links}>
          <li className={classes.link}>Features</li>
          <li className={classes.link}>Pricing</li>
          <li className={classes.link}>Resources</li>
        </ul>
        <div className={classes['sign-up-login-wrapper']}>
          <Button>Login</Button>
          <Button
            className={`${buttonClasses['btn--primary-design']} ${buttonClasses['btn--border-radius']}`}
          >
            Sign Up
          </Button>
        </div>
      ...
      <div
        className={`${classes['menu-control']} ${
          isMenuButtonClick ? classes['menu-control--open'] : ''
        }`}
